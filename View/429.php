        ...
        <div class="col-12">
            <div class="d-flex justify-content-center align-items-center">
                <div class="d-flex justify-content-start align-items-center">
                    <h1 class="display-1 text-danger me-3">429</h1>
                    <div style="max-width: 500px">
                        <h3><i class="bi bi-exclamation-triangle fs-1 text-danger me-2"></i>Oops! Too many requests.</h3>
                        <p>
                            Looks like you requested content too many times.
