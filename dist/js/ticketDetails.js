$(document).ready(function(){
    ...
    const Categories = {
        ...
        'HR': {label: 'HR', description: 'Human Resources related issues.', icon: 'people-fill', color: 'info', sub: {
            ...
            'Request': {label: 'Request', category: 'HR', description: 'Request related issues.', icon: 'file-earmark-text-fill', color: 'info', opts: Options, trigger: '', sub: {
        ...
        'IT': {label: 'IT', description: 'Information Technology related issues.', icon: 'cpu-fill', color: 'info', sub: {
            ...
            'Remote Assistance': {label: 'Remote Assistance', category: 'IT', description: 'Remote assistance', icon: 'file-earmark-arrow-up-fill', color: 'warning', opts: Options, trigger: ''},
        }},
