...
$(document).ready(function(){
  ...
  // Create Modal + Select2
  var AddTripModal = builder.Component(
      "modal",
      {
          callback: {
              submit: function(element,modal){
      ...
      function(modal,component){
          ...
          // Create Form
          AddTripModal.form = builder.Component(
              'form',
              component.body,
              {
                  class:{
                  ...
                  callback:{
                      submit: function(form){
                          ...
                          // Set container
                          values.container = Container.number;
              ...
              function(form,component){
                  ...
                  // Add row
                  component.row = $(document.createElement('div')).addClass('row').appendTo(component);

                  // Shipper
                  component.row.shipper = $(document.createElement('div')).addClass('col-6').appendTo(component.row);
                  form.add({
                      name: 'shipper',
                      label: 'Shipper',
                      icon: 'truck',
                      ...
                      options: [
                        ...
                        {id: '0006', text: '0006 - BRIDGEWATER, N.S.'},
                        {id: '0008', text: '0008 - DIGBY, N.S.'},
                        {id: '0009', text: '0009 - Halifax'}
                      ],
                      modal: modal.component(),
                  }, function(input){
                      component.row.shipper.append(input);
                  });
