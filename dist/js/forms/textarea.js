$(document).ready(function(){
    ...
    scriptCode += '                type: \'textare\', //Input Type' + "\n";
    ...
    scriptCode += '        form.val({description:\'Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...\'}); // Sets Form Value' + "\n";
