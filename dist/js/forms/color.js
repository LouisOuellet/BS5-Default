$(document).ready(function(){
    ...
    scriptCode += '            {' + "\n";
    scriptCode += '                name: \'color\', //Input Name' + "\n";
    scriptCode += '                label: \'Color\', //Input Label' + "\n";
    scriptCode += '                icon: \'palette\', //Input Icon' + "\n";
    scriptCode += '                type: \'color\', //Input Type' + "\n";
    scriptCode += '                value: \'#133c5a\', //Input Value' + "\n";
    ...
    scriptCode += '                input.val(\'#69e5b3\'); // Sets Input Value' + "\n";
    scriptCode += '            },' + "\n";
    scriptCode += '        );' + "\n";
    scriptCode += '' + "\n";
    scriptCode += '        form.reset(); // Resets Form' + "\n";
    scriptCode += '        form.val({color:\'#69e5b3\'}); // Sets Form Value' + "\n";
