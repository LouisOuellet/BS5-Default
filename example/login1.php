...
<body class="h-100 w-100">
	...
	<!-- ======= Main ======= -->
	<main class="h-100">
        <div class="h-100 ms-auto col-5 text-bg-dark text-bg-glass d-flex flex-column align-items-center justify-content-center">
            <h3 class="mb-3">Login</h3>
            <form method="post" class="w-100 px-5">
                ...
                <div class="d-flex align-items-center justify-content-between w-100 mt-3">
                    <a href="forgot2.php">I forgot my password</a>
